...
urlpatterns = [ 
    ...
    path('update/clinicalchemistry/<int:id>/', views.updateChemistry, name="updateChemistry"), 
    path('update/hematology/<int:id>/', views.updateHematology, name="updateHematology"),
    path('update/bloodbank/<int:id>/', views.updateBloodBank, name="updateBloodBank"), 
    path('update/moleculardiagnotics/<int:id>/', views.updateMolecularDiagnotics, name="updateMolecularDiagnotics"), 
    path('update/reproductivebiology/<int:id>/', views.updateReproductiveBiology, name="updateReproductiveBiology"),
    ...
    path('delete/<int:id>/',views.deleteService),
